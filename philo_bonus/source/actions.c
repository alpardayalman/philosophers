...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/09 23:02:14 by ardayalman        #+#    #+#             */
/*   Updated: 2022/08/09 23:15:15 by ardayalman       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	while (1)
	{
		...
		while (++i < main->no_of_philosophers)
		{
			if (main->philosophers[i]->num_of_time_ate == main->all_should_eat)
				return (1);
			if (timestamp() - main->philosophers[i \
				% main->no_of_philosophers]->time_since_eat > main->time_of_death)
			{
...
void	*work(void *main_struct)
{
	...
	philos = (t_philosopher *)main_struct;
	main = philos->thread_main;
